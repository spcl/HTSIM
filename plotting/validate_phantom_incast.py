...
def create_plot(x_labels, y_values, type_plot, min_plot, max_plot, incast_am):
    ...
    plt.tight_layout()
    if (type_plot == "completion"):
        plt.savefig("out{}_completion.png".format(incast_am), bbox_inches='tight')
        plt.savefig("out{}_completion.pdf".format(incast_am), bbox_inches='tight')
    elif (type_plot == "trimming"):
        plt.savefig("out{}_trimming.png".format(incast_am), bbox_inches='tight')
        plt.savefig("out{}_trimming.pdf".format(incast_am), bbox_inches='tight')
    else:
        plt.savefig("out{}_trimming_after.png".format(incast_am), bbox_inches='tight')
        plt.savefig("out{}_trimming_after.pdf".format(incast_am), bbox_inches='tight')
