...
def main():
    ...
    list_custom_names = ["AliIntra", "AliInter", "Incast_InterDC_Mixed"]
    list_exp = ["AliIntra", "Ali", "incast_mixed_interdc_large"]
    list_exp = ["ali_mixed.tmp", "ali_inter.tmp"]
    list_topo = ["fat_tree_128_4os.topo", "fat_tree_128_4os.topo"]
