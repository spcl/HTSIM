    ...
    for rt in rou:
        for tra in tp:
            ...
            for mes in ms:
                for s in siz:
                    for file in files:
                        os.system("cp ./{}/{}/{}/{}N/{}MiB/{} ./Plots/{}/{}/{}/{}N/{}MiB/".format(top, rt, tra, s, mes, file, top, rt, tra, s, mes))
                """ # strn = ""
                if(tra == "Incast"):
                    for i,s in enumerate(siz):
                        # strn = "corvin{}{}{}{}_{}N{}MiB".format(top, rt, tra, incast_size[i], s, mes)
                        for file in files:
                            os.system("cp ./experiments/{}/{}/{}/{}N/{}MiB/{} ./Plots/{}/{}/{}/{}N/{}MiB/".format(top, rt, tra, s, mes, file, top, rt, tra, s, mes))
                        # mkdir --parents ./Plots/{}/{}/{}/{}N/{}MiB/ && 
