...
def execute_string(string_to_run, experiment, out_name):
    ...
    os.system("cp -a ../../sim/output/cwd/. experiments4MB/{}/cwd/".format(experiment))
    os.system("cp -a ../../sim/output/rtt/. experiments4MB/{}/rtt/".format(experiment))
    os.system("cp -a ../../sim/output/queue/. experiments4MB/{}/queue_size_normalized/".format(experiment))
    os.system("cp -a ../../sim/output/switch_drops/. experiments4MB/{}/switch_drops/".format(experiment))
    os.system("cp -a ../../sim/output/cable_drops/. experiments4MB/{}/cable_drops/".format(experiment))
    os.system("cp -a ../../sim/output/switch_failures/. experiments4MB/{}/switch_failures/".format(experiment))
    os.system("cp -a ../../sim/output/cable_failures/. experiments4MB/{}/cable_failures/".format(experiment))
    os.system("cp -a ../../sim/output/routing_failed_switch/. experiments4MB/{}/routing_failed_switch/".format(experiment))
    os.system("cp -a ../../sim/output/routing_failed_cable/. experiments4MB/{}/routing_failed_cable/".format(experiment))
    os.system("cp -a ../../sim/output/switch_degradations/. experiments4MB/{}/switch_degradations/".format(experiment))
    os.system("cp -a ../../sim/output/cable_degradations/. experiments4MB/{}/cable_degradations/".format(experiment))
    os.system("cp -a ../../sim/output/random_packet_drops/. experiments4MB/{}/random_packet_drops/".format(experiment))
    os.system("cp -a ../../sim/output/packet_seq/. experiments4MB/{}/packet_seq/".format(experiment))
    os.system("cp -a ../../sim/datacenter/{}.txt experiments4MB/{}/{}.txt".format(out_name, experiment,out_name))
...
def getMaxTotalOutOfOrderPackets(experiment):
    os.chdir("experiments4MB/" + experiment+"/")
...
def run(
    ...
    print("Running 4MB: {}".format(title))

    os.system("mkdir experiments4MB/{}".format(short_title))
    os.system("mkdir to_upload4MB/{}".format(short_title))
    ...
    filename = "experiments4MB/{}/{}.txt".format(short_title,balancer)
    ...
    complete_plot = run_complete(title,short_title,"4MB")
    complete_plot.write_image("experiments4MB/{}/complete_plot_{}.pdf".format(short_title,balancer))
    complete_plot.write_image("to_upload4MB/{}/complete_plot_{}.pdf".format(short_title,balancer))
    # print(
    ...
    filename = "experiments4MB/{}/{}NoFailures.txt".format(short_title,balancer)
    ...
    filename = "experiments4MB/{}/{}NoFreezing.txt".format(short_title,balancer)
    ...
    complete_plot = run_complete(title,short_title,"4MB")
    complete_plot.write_image("experiments4MB/{}/complete_plot_{}NoFreezing.pdf".format(short_title,balancer))
    complete_plot.write_image("to_upload4MB/{}/complete_plot_{}NoFreezing.pdf".format(short_title,balancer))
    # print(
    ...
    filename = "experiments4MB/{}/{}NoFreezingNoFailures.txt".format(short_title,balancer)
    ...
    plt.savefig(
        "experiments4MB/{}/completion.pdf".format(short_title), bbox_inches="tight"
    )
    plt.savefig(
        "to_upload4MB/{}/completion.pdf".format(short_title), bbox_inches="tight"
    )
    plt.close()
    ...
    plt.savefig(
        "to_upload4MB/{}/lost_packets.pdf".format(short_title), bbox_inches="tight"
    )
    plt.close()
    ...
    plt.savefig("to_upload4MB/{}/total_out_of_order.pdf".format(short_title), bbox_inches="tight")
    plt.close()
    ...
    plt.savefig("to_upload4MB/{}/out_of_order_ratio.pdf".format(short_title), bbox_inches="tight")
    plt.close()
    ...
    plt.savefig("to_upload4MB/{}/out_of_order_distance.pdf".format(short_title), bbox_inches="tight")
    plt.close()
    return list_max

def main():

    os.system("rm -rf experiments4MB/")
    os.system("mkdir -p experiments4MB")
    os.system("rm -rf to_upload4MB/")
    os.system("mkdir -p to_upload4MB")

    titles = [
        "Permutation 128 - 800Gpbs - 4KiB MTU - 1:1 Oversubscription - 4MB Flows \n Failure mode: One failed switch at 10µs for 100µs",
        "Permutation 128 - 800Gpbs - 4KiB MTU - 8:1 Oversubscription - 4MB Flows \n Failure mode: One failed switch at 10µs for 100µs",
        "Incast 32:1 - 800Gpbs - 4KiB MTU - 1:1 Oversubscription - 4MB Flows \n Failure mode: One failed switch at 10µs for 100µs",
    ...
    for i, title in enumerate(titles):
        ...
        df = pd.DataFrame(data)
        df.to_csv('experiment_data4MB.csv', index=False)
