            ...
            for mes in ms:
                ...
                if(tra == "Incast"):
                    for i,s in enumerate(siz):
                        ...
                        # for file in files:
                        os.system("mkdir --parents ./corvin/{}/{}/{}/{}N/{}MiB/ && mv {} ./corvin/{}/{}/{}/{}N/{}MiB/".format(top, rt, tra, s, mes, strn, top, rt, tra, s, mes))
                        # os.system("rmdir ./experiments/{}".format(strn))
                else:
                    for s in siz:
                        strn = "corvin{}{}{}{}N{}MiB".format(top, rt, tra, s, mes)
                        # for file in files:
                        os.system("mkdir --parents ./corvin/{}/{}/{}/{}N/{}MiB/ && mv {} ./experiments/corvin/{}/{}/{}/{}N/{}MiB/".format(top, rt, tra, s, mes, strn, top, rt, tra, s, mes))
                        # os.system("rmdir ./experiments/{}".format(strn))