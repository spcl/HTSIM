...
#ifndef _HAMMINGMESH_SWITCH
#define _HAMMINGMESH_SWITCH
...
class HammingmeshSwitch : public Switch {
  public:
    ...
    HammingmeshSwitch(EventList &eventlist, string s, switch_type t, uint32_t id,
                  simtime_picosec switch_delay, HammingmeshTopology *ht);
    HammingmeshSwitch(EventList &eventlist, string s, switch_type t, uint32_t id,
                  simtime_picosec switch_delay, HammingmeshTopology *ht, uint32_t strat);
    ...
    static routing_strategy _hm_strategy;
